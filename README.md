...
## Environments
- Preview: https://main--aem-builerplate-ue-2--mayankjindalmj.hlx.page/
- Live: https://main--aem-builerplate-ue-2--mayankjindalmj.hlx.live/
...
1. Open the `aem-builerplate-ue-2` directory in your favorite IDE and start coding :)
